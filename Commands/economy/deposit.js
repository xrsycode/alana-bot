...
module.exports = {
    ...
    .setDescription('Deposit money from you wallet into your bank.')
    ...
    async execute(interaction) {
        ...
        if(Amount.toLowerCase() === "all") {
            if (Data.Wallet === 0) return interaction.reply({ content: "You don't have money in your wallet to deposit it into your bank." })
            ...
            if (Data.Wallet < parseInt(Converted) || Converted === Infinity) return interaction.reply({ content: "You don't have money in your wallet to deposit it into your bank." })
